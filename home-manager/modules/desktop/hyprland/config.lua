...
opacity({ class = "^(thunar|Steam|steam|steamwebhelper|Spotify|VSCodium|codium-url-handler|code|code-url-handler|terminalFileManager|org.kde.dolphin|org.kde.ark|nwg-look|qt5ct|qt6ct|yad)$" }, "0.80 0.80")
opacity({ title = ".*(Spotify).*" }, "0.80 0.80")
opacity({ class = "^(com.github.rafostar.Clapper|discord|WebCord)$" }, "0.90 0.90")
opacity({ class = "^(com.github.tchx84.Flatseal|hu.kramo.Cartridges|com.obsproject.Studio|gnome-boxes|app.drey.Warp|net.davidotek.pupgui2|Signal|io.gitlab.theevilskeleton.Upscaler)$" }, "0.80 0.80")
opacity({ class = "^(pavucontrol|org.pulseaudio.pavucontrol|blueman-manager|.blueman-manager-wrapped|nm-applet|nm-connection-editor|org.kde.polkit-kde-authentication-agent-1)$" }, "0.80 0.70")
...
for _, class in ipairs({
  "qt5ct", "nwg-look", "org.kde.ark", "Signal", "com.github.rafostar.Clapper",
  "app.drey.Warp", "net.davidotek.pupgui2", "eog", "io.gitlab.theevilskeleton.Upscaler",
  "yad", "pavucontrol", "blueman-manager", ".blueman-manager-wrapped", "nm-applet",
